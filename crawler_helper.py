...
def get_datetimes(driver):
    ...
    select_element = driver.find_element(By.ID, "ddlpricedate")
...
def get_data(after_date: pd.Timestamp = None):
    ...
    for scan_datetime in datetimes:
        ...
        if after_date is None or pd_date > after_date:
            ...
            tbody_ele = driver.find_element(By.XPATH, r"//div[contains(@class, 'news-filter-content')]//table/tbody")
...
if __name__ == "__main__":
    # driver = open_web()
    # print(get_datetimes(driver))
    print(get_data(pd.Timestamp("6/1/2024")))
    pass
